...
- MultiDTB FIT: [qcom-dtb-metadata](https://github.com/qualcomm-linux/qcom-dtb-metadata) → VFAT `dtb.bin` (`qclinux_fit.img`)
...
# result/image/                  (Image, lemans-evk.dtb)
...
| CDT | Codelinaro `…/QCS9100/cdt/rb8_core_kit.zip` → flashed as `cdt.bin` |
| GPT / QDL | Generated by `iq-9075-evk-partitions` (qcom-ptool) |
| `dtb.bin` | Built by `iq-9075-evk-dtb-bin` (FIT + VFAT) |
