...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    install -D -m 644 $(find zip_out -name "1714-1-0x8.bin" | head -1) $out/lib/firmware/1714-1-8.bin
    install -D -m 644 $(find zip_out -name "1714-1-0xB.bin" | head -1) $out/lib/firmware/1714-1-B.bin
  '';
