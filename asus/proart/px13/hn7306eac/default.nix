...

{
  ...
  environment.etc = {
    "alsa/ucm2/codecs/tas2783/init.conf".source = ./ucm2/init.conf;
    "alsa/ucm2/sof-soundwire/acp-dmic.conf".source = ./ucm2/acp-dmic.conf;
    "alsa/ucm2/sof-soundwire/tas2783.conf".source = ./ucm2/tas2783.conf;
    "alsa/ucm2/sof-soundwire/sof-soundwire.conf".source = ./ucm2/sof-soundwire.conf;
  };
  ...
  services.udev.extraRules = /* udev */ ''
    ACTION=="add", SUBSYSTEM=="sound", ATTR{id}=="sofsoundwire", RUN+="${lib.getBin pkgs.alsa-utils}/bin/amixer -c $attr{device/number} set 'tas2783-1 Amp Playback Switch' 1"
  '';
}
